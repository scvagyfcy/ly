...
page = st.sidebar.radio(
    "选择功能",
    ["音乐播放器", "图片相册", "小组档案", "动漫视频", "美食仪表盘", "简历生成器"]
)
...
def image_gallery():
    ...
    image_data = [
        ("https://picsum.photos/id/40/800/600", "橘白相间的猫咪，正慵懒地晒太阳"),
        ("https://picsum.photos/id/237/800/600", "活泼的小狗在草地上奔跑"),
        ("https://picsum.photos/id/106/800/600", "盛放的向日葵，充满生机")
    ]
...
def food_dashboard():
    ...
    # 餐厅推荐菜品 - 使用网络图片替代本地图片
    recommend_dishes = {
        "星艺会尝不忘": {"菜品": "老友粉", "图": "https://picsum.photos/id/292/800/500"},
        "高峰柠檬鸭": {"菜品": "柠檬鸭", "图": "https://picsum.photos/id/431/800/500"},
        "复记老友粉": {"菜品": "经典老友粉", "图": "https://picsum.photos/id/488/800/500"},
        "好友缘": {"菜品": "自助海鲜", "图": "https://picsum.photos/id/493/800/500"},
        "西冷牛排店": {"菜品": "西冷牛排", "图": "https://picsum.photos/id/312/800/500"}
    }
