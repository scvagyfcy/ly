...
train_config = {
    "数字档案": {"file_path": "second.py", "desc": "HTML/CSS基础布局实训"},
    "南宁美食数据仪表": {"file_path": "first.py", "desc": "JavaScript交互实训"},
    "相册": {"file_path": "third.py", "desc": "JavaScript交互实训"},
    "音乐播放器": {"file_path": "forth.py", "desc": "JavaScript交互实训"},
    "视频网站": {"file_path": "abb.py", "desc": "JavaScript交互实训"},
    "羊羊简历": {"file_path": "add.py", "desc": "JavaScript交互实训"},
